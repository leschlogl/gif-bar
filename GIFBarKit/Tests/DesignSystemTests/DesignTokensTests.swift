...
final class DesignTokensTests: XCTestCase {
    func testLayoutConstants() {
        ...
        XCTAssertEqual(DesignTokens.Layout.toolbarHeight, 60)
    ...
    func testRadiusConstants() {
        ...
        XCTAssertEqual(DesignTokens.Radius.searchField, 10)
    ...
    func testSpacingConstants() {
        ...
        XCTAssertEqual(DesignTokens.Spacing.toolbarItemGap, 10)
    }
}
